...
function LandingPage() {
  ...
  const blockchainLogos = [
    ...
    { src: ethereumLogo, name: 'Ethereum', color: '#627eea' },
    ...
    { src: algorandLogo, name: 'Algorand', color: '#000000' },
    { src: binanceLogo, name: 'Binance Coin', color: '#f3ba2f' },
    { src: cosmosLogo, name: 'Cosmos', color: '#2e3148' },
    { src: fantomLogo, name: 'Fantom', color: '#1969ff' },
    { src: nearLogo, name: 'NEAR Protocol', color: '#00c08b' },
    { src: stellarLogo, name: 'Stellar', color: '#7d00ff' },
    { src: tezosLogo, name: 'Tezos', color: '#2c7df7' }
  ]
